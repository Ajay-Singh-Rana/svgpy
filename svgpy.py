...
class SVG:
    ...
    # a function to draw an elliptical arc curve by shifting
    def shift_arc(self, point : Point, radii, angle, flags):
        """This function draws an arc curve from the current point to the 
        coordinates specified by current point shifted by point.x along x-axis
        and point.y along y-axis. The center of the ellipse used to 
        draw the arc is determined automatically based on the other
        parameters. radii specifies x-radius and y-radius, angle specifies
        rotation and flags specify between large arc or sweep arc:
            1. large-arc-flag allows to chose one of the large arc (1)
...
obj.arc(Point(75,150),(90,80),20,(1,1))
obj.shift_arc(Point(275,150),(90,80),20,(1,1))
obj.end_path(True)
